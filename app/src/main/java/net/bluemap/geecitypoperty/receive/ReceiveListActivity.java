...
public class ReceiveListActivity extends AppCompatActivity {
    ...
    @ViewInject(id = R.id.ar_spn_area)
    Spinner spnArea;
    @ViewInject(id = R.id.ar_spn_type)
    Spinner spnType;
    ...
    private void loadData(){
        ...
        getCourtsHPI.setListener(new WebAPIListener() {
            ...
            public void onLoadFail(int errNum, String errMessage) {
                //弹出提示
                DialogUtil.getInstance(ReceiveListActivity.this).showShortToast(errMessage);
            }
        });
